...
<body>
  ...
  <div class="home-section">
    <nav>
      ...
      <div class="profile-details">
        <img src="./admin.png" alt="Logo Administrator">
  ...
  <div class="home-content">
    ...
    <button class= "btn btn-tambah">
      <i class="bx bx-plus"></i><a href="bahanbaku-entry.html"> Tambah Data </a>
		</button>
                      ...
                      <tr>
                        ...
                        <td>
                          <button class= 'btn btn-edit'>
		                          <a href='bahanbaku-edit.html'><i class='bx bx-edit'></i> Edit </a>
		                      </button>
                          <button class= 'btn btn-delete'>
		                          <a href='bahanbaku-hapus.html'><i class='bx bx-trash'></i> Hapus </a>
		                      </button>
                        </td>
                      </tr>
                    "; } ?>
